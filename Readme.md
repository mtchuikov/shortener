# shortener
Сервис для укорачивания ссылок. Принимает в запросе URL, соответствующий стандарту [RFC 1738](https://www.rfc-editor.org/rfc/rfc1738) и возвращает короткий идентификатор ресурса, состоящий из 8 символов верхнего и нижнего 
